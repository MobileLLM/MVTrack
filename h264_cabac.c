            ...
            for(i=0; i<4; i++){
                ...
                if(IS_DIR(sl->sub_mb_type[i], 0, list) && !IS_DIRECT(sl->sub_mb_type[i])){
                    ...
                    for(j=0; j<sub_partition_count[i]; j++){
                        ...
                        mv_cache[ 0 ][0]= mx;
                        mv_cache[ 0 ][1]= my;
                        ref_l=sl->ref_list[list][ sl->ref_cache[list][ scan8[index] ]];
                        //fprintf(fp, "mv[%d]:%d/%d ref%d \n", list,mx,my,ref_l.poc-65536);
        ...
        if(IS_16X16(mb_type)){
            ...
            for (list = 0; list < sl->list_count; list++) {
                if(IS_DIR(mb_type, 0, list)){
                    ...
                    ff_tlog(h->avctx, "final mv:%d %d\n", mx, my);
                    ref_l=sl->ref_list[list][ sl->ref_cache[list][ scan8[0] ]];
                    //fprintf(fp, "mv[%d]:%d/%d ref%d \n", list,mx,my,ref_l.poc-65536);
                    fprintf(fp, "list:%d mv:%d/%d ref:%d \n", list, mx, my, ref_l.poc - 65536);
            ...
            for (list = 0; list < sl->list_count; list++) {
                for(i=0; i<2; i++){
                    if(IS_DIR(mb_type, i, list)){
                        ...
                        ff_tlog(h->avctx, "final mv:%d %d\n", mx, my);
                        ref_l=sl->ref_list[list][ sl->ref_cache[list][ scan8[0] +16*i]];
                        //fprintf(fp, "mv[%d]:%d/%d ref%d \n", list,mx,my,ref_l.poc-65536);
                        fprintf(fp, "list:%d mv:%d/%d ref:%d \n", list, mx, my, ref_l.poc - 65536);
            ...
            for (list = 0; list < sl->list_count; list++) {
                for(i=0; i<2; i++){
                    if(IS_DIR(mb_type, i, list)){
                        ...
                        ff_tlog(h->avctx, "final mv:%d %d\n", mx, my);
                        ref_l=sl->ref_list[list][ sl->ref_cache[list][ scan8[0] +2*i]];
                        //fprintf(fp, "mv[%d]:%d/%d ref%d \n", list,mx,my,ref_l.poc-65536);
                        fprintf(fp, "list:%d mv:%d/%d ref:%d \n", list,mx,my,ref_l.poc-65536);
